...
class MVBenchDataset(EvalDataset):
    data_list_info = {
        ...
        "Action Sequence": (
            ...
            "DATAS/MVBench/video/star/Charades_v1_480/",
            "video",
            True,
        ),  # has start & end
        "Action Prediction": (
        ...
        "Action Antonym": (
            "action_antonym.json",
            "DATAS/MVBench/video/ssv2_video/",
            "video",
            False,
        ),
        "Fine-grained Action": (
            "fine_grained_action.json",
            "DATAS/MVBench/video/Moments_in_Time_Raw/videos/",
            "video",
            False,
        ),
        "Unexpected Action": (
            "unexpected_action.json",
            "DATAS/MVBench/video/FunQA_test/test/",
            "video",
            False,
        ),
        "Object Existence": (
            "object_existence.json",
            "DATAS/MVBench/video/clevrer/video_validation/",
            "video",
            False,
        ),
        "Object Interaction": (
        ...
        "Object Shuffle": (
            "object_shuffle.json",
            "DATAS/MVBench/video/perception/videos/",
            "video",
            False,
        ),
        "Moving Direction": (
        ...
        "Action Localization": (
            ...
            "DATAS/MVBench/video/sta/sta_video/",
            "video",
            True,
        ),  # has start & end
        "Scene Transition": (
            "scene_transition.json",
            "DATAS/MVBench/video/scene_qa/video/",
            "video",
            False,
        ),
        "Action Count": (
        ...
        "Egocentric Navigation": (
            ...
            "DATAS/MVBench/video/vlnqa/",
            "video",
            False,
        ),
        "Episodic Reasoning": (
            "episodic_reasoning.json",
            "DATAS/MVBench/video/tvqa/frames_fps3_hq/",
            "frame",
            True,
