...
def upload_img(gr_img, gr_video, chat_state=None, num_segments=None, img_list=None):
    ...
    if gr_img is None and gr_video is None:
        return (
            ...
            gr.update(interactive=True, placeholder="Please upload video/image first!"),
            chat_state,
            None,
        )
    if gr_video:
...
description = """<br><p><a href='https://github.com/magic-research/PLLaVA'>
    # PLLAVA!
...
with gr.Blocks(
    ...
    with gr.Row():
        with gr.Column(scale=0.5, visible=True) as video_upload:
            ...
            with gr.Tab("Image", elem_id="image_tab"):
                up_image = gr.Image(
                    type="pil", interactive=True, elem_id="image_upload", height=360
                )
    ...
    upload_button.click(
        upload_img,
        [up_image, up_video, chat_state],
        [up_image, up_video, text_input, upload_button, chat_state, img_list],
    )

    text_input.submit(
        gradio_ask,
        [text_input, chatbot, chat_state, system_string],
    ...
    clear.click(
        gradio_reset,
        [chat_state, img_list],
        [chatbot, up_image, up_video, text_input, upload_button, chat_state, img_list],
        queue=False,
    )
