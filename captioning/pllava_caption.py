...
def single_test(model, processor, vid_path, num_frames=4, conv_mode="plain"):
    ...
    def load_video(video_path, num_segments=8, return_msg=True, num_frames=4, resolution=336):
    ...
    conv.user_query(query_action, None, None, is_mm=True)
...
def run(rank, args, world_size):
    ...
    model, processor = load_model_and_dataset(rank,
                                                       world_size,
