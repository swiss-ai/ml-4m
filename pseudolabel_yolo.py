...
def save_pseudo_detection(config_file, model_weights, classes_list, rgb_dir, save_dir, thresh=0.2, device="cuda:0", save_segmentation=True):
...
if __name__ == '__main__':
    ...
    if folder_list is None:
        save_pseudo_detection(config_file=args.config_file, model_weights=args.model_weights, classes_list=None,
    ...
    for gpu_idx in range(args.n_gpus):
        for proc_idx in range(args.n_proc_per_gpu):
            ...
            func = Process(target=partial(
                ...
                config_file=args.config_file, model_weights=args.model_weights,
