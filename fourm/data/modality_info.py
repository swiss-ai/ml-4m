...
MODALITY_INFO = {
    ...
    "metadata": {
        ...
        "encoder_embedding": partial(
            SequenceEncoderEmbedding, vocab_size=30_000, max_length=40, padding_idx=0, sincos_pos_emb=True
        ),
        "decoder_embedding": partial(
            SequenceDecoderEmbedding, vocab_size=30_000, max_length=40, padding_idx=0, sincos_pos_emb=True
        ),
        "min_tokens": 0,
    ...
    "human_poses": {
        "vocab_size": 30_000,
        "encoder_embedding": partial(
            SequenceEncoderEmbedding, vocab_size=30_000, max_length=263, padding_idx=0, sincos_pos_emb=True
        ),
        "decoder_embedding": partial(
            SequenceDecoderEmbedding, vocab_size=30_000, max_length=263, padding_idx=0, sincos_pos_emb=True
        ),
        "min_tokens": 0,
    ...
    "color_palette": {
        "vocab_size": 30_000,
        "encoder_embedding": partial(
            SequenceEncoderEmbedding, vocab_size=30_000, max_length=23, padding_idx=0, sincos_pos_emb=True
        ),
        "decoder_embedding": partial(
            SequenceDecoderEmbedding, vocab_size=30_000, max_length=23, padding_idx=0, sincos_pos_emb=True
        ),
        "min_tokens": 0,
    ...
    "sam_instance": {
        "vocab_size": 30_000,
        "encoder_embedding": partial(
            SequenceEncoderEmbedding, vocab_size=30_000, max_length=290, padding_idx=0, sincos_pos_emb=True
        ),
        "decoder_embedding": partial(
            SequenceDecoderEmbedding, vocab_size=30_000, max_length=290, padding_idx=0, sincos_pos_emb=True
        ),
        "min_tokens": 0,
        "max_tokens": 290,
        "type": "seq",
...
MODALITY_TRANSFORMS = {
    ...
    "metadata": MetadataTransform(
        special_vmin=0, special_vmax=999, shuffle=True, random_trunc=False, return_chunks=True
    ),
